function clicou(eve, bot){
	...
	if(qual == "nok"){
		document.getElementById(bot).className = "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored"; /*accent*/
/* 		document.getElementById(bot).style.border = "3px solid #1E88E5";
		...
		document.getElementById(bot).className = "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"; /*colored*/
